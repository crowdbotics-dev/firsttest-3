"""
Django settings for firsttest_3 project.
...
WSGI_APPLICATION = 'firsttest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "firsttest_3 API",
    "DESCRIPTION": "API documentation for firsttest_3 App",
    "VERSION": "v1",
}
